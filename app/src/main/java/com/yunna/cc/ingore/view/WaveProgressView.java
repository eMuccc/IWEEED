package com.yunna.cc.ingore.view;
...
import com.yunna.cc.ingore.util.DpOrPxUtils;
...
public class WaveProgressView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        waveWidth = typedArray.getDimension(R.styleable.WaveProgressView_wave_width, DpOrPxUtils.INSTANCE.dip2px(context, 25));
        waveHeight = typedArray.getDimension(R.styleable.WaveProgressView_wave_height, DpOrPxUtils.INSTANCE.dip2px(context, 5));
        ...
        defaultSize = DpOrPxUtils.INSTANCE.dip2px(context, 100);
